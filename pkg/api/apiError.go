...
// apiError.go contains implement of api error type.
...
// this consts are used to form error messages
const (
...
// apiErrorHandle creates apiError and returns JSON serialized object of api error type.
